    ...
    return (
        <div className="navbar shadow-sm bg-blue-950">
            ...
            <div className="navbar-end text-white">
                ...
                <Link to="/room-types" className="btn btn-ghost bg-blue-300">Room Types</Link>
                <Link to="/new-meal-plan" className="btn btn-ghost bg-blue-300">New Meal Plan</Link>
                <Link to="/meal-plans" className="btn btn-ghost bg-blue-300">Meal Plans</Link>
